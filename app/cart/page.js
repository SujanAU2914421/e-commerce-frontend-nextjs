	...
	return user ? (
		<div className="relative h-screen w-screen overflow-x-hidden overflow-y-auto">
			...
			<div className="relative h-auto w-full flex xl:justify-center lg:justify-center md:justify-center pb-16">
				...
				>
					{/* Title */}
					<div className="relative text-xl font-extrabold font-sans">Your Cart</div>
					...
					{cartItems && cartItems.length > 0 ? (
						...
						<div className="relative text-lg font-medium text-gray-500">Your cart is empty.</div>
					)}
					{wishList.filter((product) => !cartItems.some((cartItem) => cartItem.product_id === product.product_id))
						.length > 0 ? (
						<>
