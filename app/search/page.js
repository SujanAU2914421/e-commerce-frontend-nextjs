...
export default function SearchPageUi() {
	const { searchQuery, setSearchQuery, searchProducts } = useMainContext();
	...
	return (
		<div className="relative h-screen w-screen" style={{ fontFamily: "afacad-flux" }}>
						...
						<div className="relative flex flex-col gap-4">
							...
							<div className="relative flex flex-col gap-2">
								<div className="relative text-gray-700">
									Showing Results For: <span className="relative font-bold text-xl text-gray-700">Hoodies</span>
								</div>
							</div>
						</div>
					</div>
