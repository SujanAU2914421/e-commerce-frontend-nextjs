						...
						<div className="relative h-auto w-full grid grid-cols-3 gap-8">
							<div className="relative col-span-1">
								<div className="relative text-xs text-gray-600 font-sans leading-5">
									Please note that your updated first name and last name will be
									...
									<div className="relative h-auto w-auto grid gap-8">
										<div className="relative h-auto w-auto flex items-center gap-4">
											<div className="relative h-auto w-auto grid gap-2">
												<div className="relative h-auto text-xs font-bold text-gray-500">
													First Name
												</div>
												<div className="relative h-auto w-auto">
													<div className="relative h-10 w-56 border rounded overflow-hidden">
														<input
															type="text"
										...
										<div className="relative h-auto w-auto">
											<div className="relative h-10 w-56 bg-gray-700 cursor-pointer text-white flex items-center justify-center rounded text-xs font-bold">
												Change
											</div>
										</div>
									</div>
				...
				<div className="relative h-auto w-full grid gap-4">
					...
					<div className="relative h-auto w-full border-t pt-4">
						<div className="relative h-auto w-full grid grid-cols-3 gap-8">
							<div className="relative col-span-1">
								<div className="relative text-xs text-gray-600 font-sans leading-5">
									Note: email address is very important information. so be
									careful while choosing one.
								</div>
							</div>
							<div className="relative col-span-2">
								<div className="relative h-auto w-auto">
									<div className="relative h-auto w-auto grid gap-4">
										<div className="relative h-auto w-auto grid gap-2">
											...
											<div className="relative h-auto w-auto">
												<div className="relative h-10 w-72 border rounded overflow-hidden">
													<input
														type="email"
														className="relative h-full w-full outline-none border-none text-xs px-4 font-bold"
