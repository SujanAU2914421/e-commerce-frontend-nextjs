...
export default function CartList() {
	...
	const products = [
		...
		},
		{
			...
			image: "https://via.placeholder.com/100",
			description:
				"Smartwatch with advanced fitness tracking and AMOLED display.",
			quantity: 1,
			rating: 4,
		...
		},
		{
			...
			image: "https://via.placeholder.com/100",
			description:
				"Industry-leading noise cancellation and crystal-clear audio.",
			quantity: 1,
			rating: 5,
			...
			<div className="relative h-auto w-full">
				<div className="relative h-auto flex justify-between items-center pt-8">
					<div className="relative h-auto flex items-center gap-2">
						...
						<div className="relative text-xl text-black font-bold">
							{products.length}
						</div>
					</div>
				...
				<div className="mt-8 grid gap-6">
					...
					{products.map((product) => (
						<div
							key={product.id}
							className="flex col-span-1 items-start border rounded-md h-56 pl-4"
						>
							...
							<div className="flex-1 w-[calc(100%-10rem)] px-4 py-4 grid gap-1">
									...
									<div className="relative">
										<div className="relative flex items-center gap-5">
											...
											<div className="relative flex items-center gap-2">
												...
												<div className="text-normal text-gray-800 font-semibold">
													${product.price}
												</div>
											</div>
										</div>
								...
								<div className="text-xs text-gray-600 mt-1 w-5/6 truncate">
									{product.description}
								</div>
