...
export default function AccordionContentDesignForQuickView({ currentItemData }) {
	...
	return (
		<Accordion type="single" collapsible>
			...
			<AccordionItem value="information">
				<AccordionTrigger className="relative font-extrabold text-gray-800">Information</AccordionTrigger>
				<AccordionContent className="relative text-gray-700">
					<div className="relative h-auto w-full grid gap-5 pt-4 text-[1rem] *:grid *:gap-2">
						<div className="relative">
							...
							<div className="relative text-gray-700">We currently offer free shipping above Rs.1299 PAN Nepal</div>
						</div>
						<div className="relative">
							<div className="relative font-bold">Return & exchange</div>
							<div className="relative text-gray-700">
								If you are not satisfied with your purchase you can return it to us within 14 days for an exchange or
								refund.
							</div>
						</div>
						<div className="relative">
							...
							<div className="relative text-gray-700">
								Contact us on (+977) 9815061114 , or email us at deecoodeer@gmail.com.
							</div>
						</div>
					</div>
				</AccordionContent>
			...
			<AccordionItem value="additionalInformation">
				<AccordionTrigger className="relative font-extrabold text-gray-800">Additional Information</AccordionTrigger>
				<AccordionContent className="relative text-gray-700">
