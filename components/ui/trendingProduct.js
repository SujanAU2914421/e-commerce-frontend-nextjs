			...
			<div className="relative flex xl:flex-row lg:flex-row flex-col-reverse xl:flex-nowrap lg:flex-nowrap flex-wrap h-full items-center gap-y-8">
				<div className="relative xl:w-1/2 lg:w-1/2 w-full xl:px-0 lg:px-0 md:px-8 sm:px-8 px-4">
					<div className="relative grid gap-8">
						...
						>
							<Link
								href={`/shop/${trendingProduct.category}/${trendingProduct.id}`}
							...
							<div className="relative flex items-center gap-4">
								<div className="relative flex items-center w-24">
									{trendingProduct.reviews.map((review, index) => {
										return (
											<div
												key={index}
												className={`absolute h-9 w-9 rounded-full bg-primary-foreground p-[2px]`}
												style={{
													left: `${index * 20}px`,
												}}
											>
								...
								<div className="relative grid">
									<div className="relative text-yellow-500">
										{
											<RatingsStar
												currentProduct={trendingProduct}
												gap={1}
												size={10}
												color="red"
											/>
									...
									<div className="relative flex items-center gap-2">
										<div className="relative text-xs text-gray-800 font-bold">
											100+
										</div>
					...
					<div className="relative w-full flex h-full">
						<div className="relative w-full h-full">
							<div
								...
								style={{
									background: `url(${trendingProduct.images[0]}) center / cover`,
								}}
							></div>
						</div>
